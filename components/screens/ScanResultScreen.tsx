  ...
  return (
    <div className="flex h-full flex-col px-3 pb-3 pt-9 text-cream">
      <motion.div {...enter(show, 0.3)}>
        <p className="text-[7px] uppercase tracking-[0.28em] text-pink">
          Tu platillo
        </p>
      ...
      <motion.div {...enter(show, 0.7)} className="mt-2">
        ...
        <div className="mt-1 flex flex-col gap-1">
          <div className="flex items-center justify-between rounded-lg border border-cream/[0.08] px-2 py-1.5">
            <span>
              <span className="block text-[8.5px] font-semibold">Salmón</span>
              <span className="text-[6.5px] text-cream/50">
                38 g proteína · 309 kcal
              </span>
            </span>
            <span className="rounded-md border border-cream/15 px-1.5 py-0.5 text-[7px] text-cream/80">
              150 g
            </span>
          </div>
          <div className="flex items-center justify-between rounded-lg border border-cream/[0.08] px-2 py-1.5">
            <span className="text-[8.5px] font-semibold">Tomates cherry</span>
            <span className="rounded-md border border-cream/15 px-1.5 py-0.5 text-[7px] text-cream/80">
              50 g
            </span>
          </div>
          <div className="flex items-center justify-between rounded-lg border border-cream/[0.08] px-2 py-1.5">
            <span className="text-[8.5px] font-semibold">Crema</span>
            <span className="rounded-md border border-cream/15 px-1.5 py-0.5 text-[7px] text-cream/80">
              30 g
            </span>
          </div>
      ...
      <motion.div {...enter(show, 0.95)} className="mt-auto">
        <div className="flex items-baseline justify-between px-0.5">
          <span className="text-[6.5px] uppercase tracking-[0.25em] text-cream/50">
            En total
          </span>
          <span className="text-[7.5px] text-cream/85">
            <b>39 g</b> proteína · <b>548</b> kcal · <b>2 g</b> azúcar
          </span>
        </div>
        <div className="mt-1.5 rounded-full bg-pink-soft py-1.5 text-center text-[8px] font-bold tracking-[0.2em] text-white shadow-[0_0_16px_rgba(233,30,99,0.45)]">
          CONFIRMAR
        </div>
      </motion.div>
    </div>
